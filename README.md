...
NOTE: Please read the [RUN](#run) section before opening an issue.

Known Issues & Performance improvements: Currently, all products are fetched on the homepage without any limits or pagination, which can lead to performance degradation as the product catalog grows. This could impact page load times, increase server load, and negatively affect the user experience. A solution to limit the number of products displayed or implement pagination/infinite scroll is needed to mitigate this issue. 

## Demo

![screenshot](screenshot.png)

The application is deployed to AWS EC2 (in future it will be hosted on ECS containers using docker images for more scalability) and can be accessed through the following link:

[MongoBags hosted on AWS](http://9750.vinaykr.in/)
...
- MIT License
- Copyright 2024 © [Vinay Kumar](https://github.com/XpertVinay/9750-NeoSoft)
